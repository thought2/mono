...
let
  ...
  xmonadConfig = /* haskell */ ''
    ...
    shortcuts =
      ...
      , ("M-C-c",                  spawn "${pkgs.chromium}/bin/chromium")
      , ("M-C-a",                  spawn "${pkgs.chromium}/bin/chromium --app='http://ddg.gg'")
      , ("M-C-d",                  floatNext True >> spawn "${pkgs.chromium}/bin/chromium --app='http://ddg.gg'")
