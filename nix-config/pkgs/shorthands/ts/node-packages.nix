...
let
  sources = {
    ...
    "@types/yargs-12.0.10" = {
      ...
      version = "12.0.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/yargs/-/yargs-12.0.10.tgz";
        sha512 = "WsVzTPshvCSbHThUduGGxbmnwcpkgSctHGHTqzWyFg4lYAuV5qXlyFPOsP3OWqCINfmg/8VXP+zJaa4OxEsBQQ==";
      };
    };
    "abbrev-1.1.1" = {
      name = "abbrev";
